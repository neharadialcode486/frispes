                        ...
                        {SWIPER_DATA.map((items, index) => (
                            <SwiperSlide key={index}>
                                <div className="relative w-full group overflow-hidden">
                                    ...
                                    <button className='bg-off-orange z-10 max-w-[255px] transition-slow w-full justify-end items-center flex h-[72px] gap-7 group-hover:gap-5 font-lato font-bold text-lg leading-5 text-white absolute -left-[183px] p-5 group-hover:left-0 group-hover:bottom-0 bottom-12'>Check avaibility <Icon className='-rotate-90 relative w-8 h-8 justify-center items-center' iconName='downArrowIcon' /></button>
                                    <div className="bg-deep-blue absolute top-0 left-0 group-hover:px-2 overflow-hidden w-0 h-0 group-hover:w-full group-hover:h-full group-hover:z-[1] transition-slow flex flex-col justify-center items-center">
