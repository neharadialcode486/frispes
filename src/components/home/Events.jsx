                                ...
                                <div className="card-content relative transition-transform duration-1000">
                                    <div className="card-front max-w-[350px] min-h-[320px] absolute top-0 bottom-0 right-0 left-1/2 -translate-x-1/2 sm:translate-x-0 sm:left-0 w-full h-full bg-white">
                                        ...
                                        <div className="px-4 py-3.5">
                                            ...
                                            <p className='mt-1 mb-0.5 font-lato font-medium text-base leading-custom-sm text-light-gray'>{items.author}</p>
                                        </div>
                                    </div>
                                    <div className="card-back max-w-[350px] min-h-[320px] absolute top-0 bottom-0 right-0 left-1/2 -translate-x-1/2 sm:translate-x-0 sm:left-0 w-full h-full bg-white p-4 md:p-8">
                                        <p className='text-off-black font-bold font-lora text-3xl sm:text-2xl xl:text-custom-sm xl:leading-10'>{items.subTitle}</p>
                                        <p className='mt-6 text-light-gray text-base leading-custom-sm font-lato font-normal'>{items.description}</p>
                                        <div className="flex gap-6 mt-4">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <p className='text-light-gray text-base leading-custom-sm font-lato font-normal'>{items.profession}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
